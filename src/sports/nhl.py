...
class NHLAnalyzer:
    ...
    def analyze_game(
        ...
        home_stats = self.stats.fetch_team_stats(home_team, sport="hockey_nhl")
        away_stats = self.stats.fetch_team_stats(away_team, sport="hockey_nhl")
...
__all__: List[str] = ["NHLAnalyzer", "GameInfo"]
