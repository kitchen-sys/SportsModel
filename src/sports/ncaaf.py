...
class NCAAFAnalyzer:
    ...
    def analyze_game(
        ...
        home_stats = self.stats.fetch_team_stats(home_team, sport="football_cfb_fbs")
        away_stats = self.stats.fetch_team_stats(away_team, sport="football_cfb_fbs")
...
__all__: List[str] = ["NCAAFAnalyzer", "GameInfo"]
